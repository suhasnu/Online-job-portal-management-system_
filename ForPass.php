...
$sql = "select * from Employer  where UserName='".$UserName."' and Question='".$Question."' and Answer='".$Answer."'";
...
$con = mysqli_connect("localhost","root","","job");
//mysqli_select_db("job", $con);
$sql = "select * from Jobseeker  where UserName='".$UserName."' and Question='".$Question."' and Answer='".$Answer."'";
$result = mysqli_query($con,$sql);
$records = mysqli_num_rows($result);
$row = mysqli_fetch_array($result);
if ($records==0)
